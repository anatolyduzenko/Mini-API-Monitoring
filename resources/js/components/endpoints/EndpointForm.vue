...
<template>
    <div v-if="show" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
        <div class="w-[60%] rounded bg-white p-6 shadow-lg">
            <h3 class="mb-4 text-lg font-bold">{{ editableEndpoint.id ? 'Edit Endpoint' : 'Add New Endpoint' }}</h3>

            <div class="flex flex-1 flex-col gap-4 rounded-xl p-4">
                <div class="grid auto-rows-max grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-2">
                    <div>
                        ...
                        <input v-model="editableEndpoint.alert_threshold" id="threshold" type="number" class="mb-3 w-full rounded border p-2" />
